...
col.set2=brewer.pal(8, "Set2")
col.set3=brewer.pal(12, "Set3")
col.pastel1=brewer.pal(9, "Pastel1")
col.pastel2=brewer.pal(8, "Pastel2")
col.dark2=brewer.pal(8, "Dark2")
col.accent=brewer.pal(8, "Accent")
col.all=unique(c(col.set1,col.set2,col.set3,col.dark2,col.accent,col.paired,col.pastel2,col.pastel1))
